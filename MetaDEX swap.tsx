...
import DEXStore from '../MetaDEXstores/useDEX'
...
export default function Swap() {
  ...
  const connection = MetaDEX(para1)
  const connected = MetaDEX(para2)
  const wallet = MetaDEX(para3)
  const actions = MetaDEX(para4)
